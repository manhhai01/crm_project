                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="" method="">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="name" placeholder="Tên quyền"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="description" placeholder="Mô tả" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a class="btn btn-success btn-add">Add Role</a>
