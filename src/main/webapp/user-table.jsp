            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="#" class="btn btn-sm btn-success btn-add">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody>
                                        <c:forEach items="${users}" var="user" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" userId="${user.getId()}" class="btn btn-sm btn-primary btn-update">Sửa</a>
                                                    <a href="#" userId="${user.getId()}" class="btn btn-sm btn-danger btn-delete">Xóa</a>
