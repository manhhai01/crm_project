        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" class="waves-effect"><i class="fa fa-modx fa-fw"
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="" method="">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input value="${ role.name }" type="text" id="name" placeholder="Tên quyền"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input value="${ role.description }" type="text" id="description" placeholder="Mô tả" class="form-control form-control-line"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a roleId="${ role.id }" class="btn btn-success btn-update">Update Role</a>
