...
<body>
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="${job.getName()}" id="name" placeholder="Tên công việc"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="text" value="${job.getStartDate()}" id="startDate" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="text" value="${job.getEndDate()}" id="endDate" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a jobId="${job.getId()}" class="btn btn-success btn-update">Lưu lại</a>
    ...
    <script src="js/groupwork-update.js"></script>
</body>
